...
namespace _12112020dz
{
    ...
    public static class ReportMakerHelper
    {
        public static string MeanAndStdHtmlReport(IEnumerable<Measurement> data) => 
            WrapperReportMaker.HTMLReportMaker("Mean and Std", data, ReportCalculation.MakeStatisticsMeanAndStd);

        public static string MedianMarkdownReport(IEnumerable<Measurement> data) => 
            WrapperReportMaker.MarkdownReportMaker("Median", data, ReportCalculation.MakeStatisticsMedian);

        public static string MeanAndStdMarkdownReport(IEnumerable<Measurement> measurements) => 
            WrapperReportMaker.MarkdownReportMaker("Mean and Std", measurements, ReportCalculation.MakeStatisticsMeanAndStd);

        public static string MedianHtmlReport(IEnumerable<Measurement> measurements) => 
            WrapperReportMaker.HTMLReportMaker("Median", measurements, ReportCalculation.MakeStatisticsMedian);
    }
}